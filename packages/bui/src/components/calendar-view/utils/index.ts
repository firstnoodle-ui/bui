import type { CalendarOptions, CalendarGridItem } from './types.ts';
...
export class Calendar {
    ...
    getMonthsInCurrentYear(): CalendarGridItem[] {
        ...
        for (let [index, month] of Object.values(Month).entries()) {
            monthList.push({
                label: month,
                current:

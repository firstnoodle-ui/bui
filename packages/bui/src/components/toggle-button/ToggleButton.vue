  ...
  result.push(
    ...(props.active
      ? [
          ...
          "dark:bg-blue-800/25 dark:hover:bg-blue-800/50 focus-visible:bg-blue-800/50 dark:active:bg-blue-800/75",
          "dark:border-action dark:hover:border-action-hover focus-visible:border-action-hover dark:active:border-action-active",
          "dark:text-action dark:hover:text-action-hover focus-visible:text-action-hover dark:active:text-action-active",
      ]
      : [
